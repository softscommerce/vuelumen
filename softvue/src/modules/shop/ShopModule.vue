...
<script>
import AsideSlide from './views/comps/AsideSlide.vue';
import HeaderMain from './views/comps/ShopHeader.vue';
import FooterMain from './views/comps/FooterMain.vue';
import AdminSetupStore from './views/comps/AdminSetupStore.js';
...
export default {
    ...
    setup() {
        const { aside_control } = AdminSetupStore();
