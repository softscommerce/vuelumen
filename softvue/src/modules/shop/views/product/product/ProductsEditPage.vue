<template>
    <div class="product_page">
        <div class="page_setup">
            ...
            <form class="form_data" @submit.prevent="productEditSubmit" enctype="multipart/form-data">
                <div class="left">
                    <div class="_top">
                        <div class="mb_5">
                ...
                <div class="right">
                    <div class="page_sidebar">
                                        ...
                                        <div class="mb_3">
                                         ...
                                         <div class="mb_3">
                                           <BaseSelects 
                                            ...
                                            @input="displayToCategorys($event)"
                        ...
                        <div class="tags step">
                            ...
                            <div class="_foot">
                                <ul class="items">
                                    <li class="item" v-for=" tag in  tags" :key="tag">#{{tag}}

                                    </li>

                                   <!-- {{ tagFetch(product.tags)}} -->
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="_body">
                                <div class="img_set img_set_gallary" style="min-width:100%;">
                                    ...
                                    <div else style="float:left; max-width: 100%">
                                        ...
                                        <img v-for="galary in product.gallary" :key="galary.id" style="min-width: 25%; float:left; padding:3px;" v-if="image_gallary_url == ''" :src="galary.gallar_image_name" alt="Thumbnail">
...
//end category section
    ...
    const tagkeyPress = ()=>{
        ...
        const displayToCategorys =(event)=>{
            if(event != 'Category'){
        ...
        const selectedBrand  = ref('');
         ...
         onMounted(async () =>{
            ...
            for(let j  = 0; j< product.value.productinfo.inventroy_sku.length; j++){
             ...
             product.value.tags.split(',').forEach(item => {
    ...
    //   computed((product) =>{
    //           var items = '';
    //            product.value.split(',').forEach(item => {
    //             items += '#'+item+' ';
    //           });
    //           return items;
    //     });
    ...
    //     console.log(tags);
        ...
        const displayToCategory = async(event)=>{
            if(event != selectedCategory){
                ...
                Validations['category'](category_id.value, 'Category is required');
                 ...
                 category_id.value = product.value.category_id;
            }
        ...
        const productEditSubmit = async() =>{
            ...
            if(errorMsg['product_name'] =='' && errorMsg['product_description'] == '' && errorMsg['unit'] == ''  && errorMsg['rprices'] == '' && errorMsg['sprices'] == '' && errorMsg['category'] == '' && errorMsg['brand'] == ''){
               const product = await productApi.update(route.params.id, form);
